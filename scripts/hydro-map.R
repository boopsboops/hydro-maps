...
colors <- read_tsv(here("assets/colors.csv"))
...
g <- ggplot(data = africa) +
  ...
  geom_sf(data=rivers.plot[1:2000,], aes(color=factor(Reach_type), size=width, 
...
ggsave(here("temp/Africa.pdf"),g,width = 35, height = 15, units = "cm")
